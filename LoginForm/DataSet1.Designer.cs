...
namespace LoginForm {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsersTableRow : global::System.Data.DataRow {
            ...
            public bool locked {
                get {
                    return ((bool)(this[this.tableUsersTable.lockedColumn]));
                }
                set {
                    this[this.tableUsersTable.lockedColumn] = value;
                }
            }
        }
    ...
    public partial class UsersTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UsersTable] WHERE (([Id] = @Original_Id) AND ([userName] = @Or" +
                "iginal_userName) AND ([passWord] = @Original_passWord) AND ([locked] = @Original" +
                "_locked))";
...
SELECT Id, userName, passWord, locked FROM UsersTable WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, userName, passWord, locked FROM dbo.UsersTable";
        ...
        public virtual int Delete(int Original_Id, string Original_userName, string Original_passWord, bool Original_locked) {
